...
class FW_Option_Type_NewIcon extends FW_Option_Type {
    ...
    protected function _enqueue_static($id, $option, $data) {
        ...
        $uri = get_template_directory_uri() . '/framework-customizations/includes/option-types/' . $this->get_type() . '/static';
    ...
    protected function _render($id, $option, $data) {
        ...
        return fw_render_view(get_template_directory() . '/framework-customizations/includes/option-types/new-icon/view.php', compact('id', 'option', 'data', 'set'));
    }
    ...
    private function generate_unknown_set($icon) {
        return array(
            ...
            'container-class' => '',
            'groups' => array(
                'unknown' => esc_html__('Unknown Set', 'docdirect'),
            ),
            'icons' => array(
    ...
    private function get_default_sets() {
		...
		//     groups => array(
        //         array(
        //             'title' => esc_html__('Web Application Icons', 'docdirect')
        //             'icons' => array('fa fa-adjust', 'fa fa-anchor', ...),
        //         ),
        //         array(
        //             'title' => esc_html__('Transportation Icons', 'docdirect'),
        //             'icons' => array(...),
        //         ),
        //     )
        //
        ...
        return array(
            'font-awesome' => array(// http://fortawesome.github.io/Font-Awesome/icons
                ...
                'font-style-src' => get_template_directory_uri() . '/css/icomoon.css',
                'container-class' => 'fa-lg', // some fonts need special wrapper class to display properly
                'groups' => array(
                    'web-application' => esc_html__('Web Application Icons', 'docdirect'),
                    'hand' => esc_html__('Hand Icons', 'docdirect'),
                    'transportation' => esc_html__('Transportation Icons', 'docdirect'),
                    'gender' => esc_html__('Gender Icons', 'docdirect'),
                    'file-type' => esc_html__('File Type Icons', 'docdirect'),
                    //'spinner'         => 'Spinner Icons',
                    //'form-control'    => 'Form Control Icons',
                    'payment' => esc_html__('Payment Icons', 'docdirect'),
                    //'chart'           => 'Chart Icons',
                    'currency' => esc_html__('Currency Icons', 'docdirect'),
                    'text-editor' => esc_html__('Text Editor Icons', 'docdirect'),
                    'directional' => esc_html__('Directional Icons', 'docdirect'),
                    'video-player' => esc_html__('Video Player Icons', 'docdirect'),
                    'brand' => esc_html__('Brand Icons', 'docdirect'),
                    'medical' => esc_html__('Medical Icons', 'docdirect'),
                    'docdirect' => esc_html__('Doctor Directory Icons', 'docdirect'),
                ),
                'icons' => array(
                    ...
                    'icon-stethoscope' => array('group' => 'docdirect'),
                    'icon-healthcare' => array('group' => 'docdirect'),
                    'icon-capsules' => array('group' => 'docdirect'),
                    'icon-map' => array('group' => 'docdirect'),
                    'fa fa-medkit' => array('group' => 'docdirect'),
                    'fa fa-star' => array('group' => 'docdirect'),
                    'fa fa-clock-o' => array('group' => 'docdirect'),
                    'icon-FirstAidKit' => array('group' => 'docdirect'),
                    'icon-Hospitalmedicalsignalofacrossinacircle' => array('group' => 'docdirect'),
                    'icon-Clinichistorymedicalpaperonclipboard' => array('group' => 'docdirect'),
                    'icon-Pills' => array('group' => 'docdirect'),
                    'icon-BloodDonation' => array('group' => 'docdirect'),
                    'icon-hairs' => array('group' => 'docdirect'),
                    'icon-repair25' => array('group' => 'docdirect'),
                    'icon-clipboard' => array('group' => 'docdirect'),
