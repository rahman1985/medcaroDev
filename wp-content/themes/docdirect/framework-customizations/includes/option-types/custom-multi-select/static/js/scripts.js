(function ($) {
	var fw_option_custom_multi_select_initialize = function(item) {
	...
	fwEvents.on('fw:options:init', function (data) {
		data.$elements
			.find('.fw-option-type-custom-multi-select:not(.initialized)')
			.each(function () {
				fw_option_custom_multi_select_initialize($(this));
			});
