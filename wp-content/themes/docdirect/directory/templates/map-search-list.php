...
<a href="<?php echo get_author_posts_url($user->ID); ?>" class="list-avatar"><button class="tg-btn tg-btn-lg make-appointment-btn test1 list_prof" type="button">View Profile</button></a>
                                    <?php 
