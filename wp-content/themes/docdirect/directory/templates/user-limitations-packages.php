					...
					<div class="tg-description">
						...
						<div class="package-info">
							<?php if( !empty( $package_expiry ) && $package_expiry >  strtotime($current_date) ){?>
							 ...
							 <?php } else{?>
							 	<span><strong><?php esc_html_e('Your package has expired. Please renew your package to use site features.','docdirect');?></strong></span>
							 <?php }?>
						</div>
						
						<div class="package-info">
							<?php if( !empty( $user_featured ) && $user_featured >  strtotime($current_date) ){?>
								<span><strong><?php esc_html_e('Featured till','docdirect');?>&nbsp;:&nbsp;<?php echo date_i18n(get_option('date_format'),$user_featured);?></strong></span>
							<?php } else{?>
								<span><strong><?php esc_html_e('Featured listing has expired','docdirect');?></strong></span>
							<?php }?>
						</div>
