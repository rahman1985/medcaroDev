        ...
        <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right">
			<?php
				if( isset( $_GET['ref'] ) 
					...
					&& $_GET['ref'] === 'bookings' 
					&& $url_identity == $user_identity
					&& (apply_filters('docdirect_do_check_user_type',$url_identity ) === true || $db_user_type == 'visitor')
					&& (apply_filters('docdirect_is_setting_enabled',$url_identity,'appointments' ) === true || $db_user_type == 'visitor')
				){
					...
					get_template_part('directory/templates/user','doctors');
				}else{
