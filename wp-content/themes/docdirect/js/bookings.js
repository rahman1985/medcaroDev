...
jQuery(document).ready(function ($) {
	...
	jQuery(document).on('click','.bk-step-next',function(e){
		...
		var bk_videocall	     = _this.parents(".tg-appointmenttabcontent").find('input[name="bk_videocall"]').val();
		...
		var bk_booking_drugs	= _this.parents(".tg-appointmenttabcontent").find('textarea[name="booking_drugs"]').val();
