...
if( !wcfm_is_vendor() || !apply_filters( 'wcfmmp_is_allow_single_product_multivendor', true ) || !current_user_can( 'edit_products' ) || !apply_filters( 'wcfm_is_allow_manage_products', true ) || !apply_filters( 'wcfm_is_allow_add_products', true ) || !apply_filters( 'wcfm_is_allow_pm_add_products', true ) || !apply_filters( 'wcfm_is_allow_product_limit', true ) || !apply_filters( 'wcfm_is_allow_space_limit', true ) ) {
