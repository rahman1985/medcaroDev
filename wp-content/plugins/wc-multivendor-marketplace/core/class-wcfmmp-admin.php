	...
	public function wcfmmp_wcfmvm_inactive_notice() {
		...
		?>
			<div class="notice wcfm_addon_inactive_notice_box" id="wcfm-groups-sttafs-notice">
				...
				<?php echo $offer_msg; ?>
				<a href="<?php echo admin_url( 'plugin-install.php?tab=search&s=wcfm+membership' ); ?>" class="button button-primary promo-btn" target="_blank"><?php _e( 'Registration >>', 'wc-multivendor-marketplace' ); ?></a>
			</div>
		<?php
	}
