	...
	public function processing() {
	  ...
	  if(isset($wcfm_store_review_data['wcfmmp_store_review_comment']) && !empty($wcfm_store_review_data['wcfmmp_store_review_comment'])) {
	  	...
	  	$author_id      = absint($wcfm_store_review_data['wcfm_review_author_id']);
			...
			$review_title       = '';
			$review_description = apply_filters( 'wcfm_editor_content_before_save', wcfm_stripe_newline( $wcfm_store_review_data['wcfmmp_store_review_comment'] ) );
			$review_description = esc_sql( $review_description );
