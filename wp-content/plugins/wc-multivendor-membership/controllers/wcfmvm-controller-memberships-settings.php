...
class WCFMvm_Memberships_Settings_Controller {
	...
	public function processing() {
	  ...
	  if( isset( $wcfm_membership_settings_form_data['wcfmvm_registration_static_fields'] ) ) {
	  	update_option( 'wcfmvm_registration_static_fields', $wcfm_membership_settings_form_data['wcfmvm_registration_static_fields'] );
	  } else {
	  ...
	  if( isset( $wcfm_membership_settings_form_data['wcfmvm_registration_custom_fields'] ) ) {
	  	update_option( 'wcfmvm_registration_custom_fields', $wcfm_membership_settings_form_data['wcfmvm_registration_custom_fields'] );
	  }
