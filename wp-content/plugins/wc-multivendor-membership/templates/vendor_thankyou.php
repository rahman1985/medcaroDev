...
<div id="wcfm_membership_container">
  <div class="wcfm_membership_thankyou_content_wrapper">
		<?php if( ( $required_approval == 'no' ) && wcfm_is_vendor( $member_id ) ) { ?>
			...
			<a class="wcfm_submit_button" href="<?php echo apply_filters( 'wcfm_thank_you_left_button_url', get_wcfm_url() ); ?>"><?php echo apply_filters( 'wcfm_thank_you_left_button_label', __( 'Goto Dashboard', 'wc-multivendor-membership' ) ); ?> >></a>
			<a class="wcfm_submit_button" href="<?php echo apply_filters( 'wcfm_thank_you_right_button_url', get_wcfm_settings_url() ); ?>"><?php echo apply_filters( 'wcfm_thank_you_right_button_label', __( 'Setup your store', 'wc-multivendor-membership' ) ); ?> >></a>
		<?php } else { ?>
			<div class="wcfm_membership_thankyou_content">
