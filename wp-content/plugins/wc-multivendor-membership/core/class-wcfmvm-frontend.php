	  	...
	  	$current_step = wcfm_membership_registration_current_step();
			...
			switch( $current_step ) {
				case 'registration':
					...
					$wcfm_registration_params = array( 'short' => __( 'Too short', 'wc-frontend-manager' ), 'weak' => __( 'Weak', 'wc-frontend-manager' ), 'good' => __( 'Good', 'wc-frontend-manager' ), 'strong' => __( 'Strong', 'wc-frontend-manager' ), 'passowrd_failed' => __( 'Passowrd strength should be atleast "Good".', 'wc-frontend-manager' ) );
