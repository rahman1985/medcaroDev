...
$product_expiry_status = isset( $membership_expire_rules['product_status'] ) ? $membership_expire_rules['product_status'] : 'draft';
					  ...
					  <?php
					   $pages = get_pages(); 
					  	...
					  	$WCFM->wcfm_fields->wcfm_generate_form_field( array(
					  																											...
					  																											'wcfm_custom_plan_page' => array( 'label' => __('Custom Plan Page', 'wc-multivendor-membership'), 'type' => 'select', 'name' => 'membership_type_settings[wcfm_custom_plan_page]', 'options' => $pages_array, 'class' => 'wcfm-select wcfm_ele', 'label_class' => 'wcfm_title', 'value' => $wcfm_custom_plan_page, 'desc_class' => 'wcfm_page_options_desc', 'desc' => __( 'You have created your own membership plan page then set that here. It is important when vendors will change plan.', 'wc-multivendor-membership') ),
					  																											'wcfm_custom_thankyou_page' => array( 'label' => __('Custom Thank You Page', 'wc-multivendor-membership'), 'type' => 'select', 'name' => 'membership_type_settings[wcfm_custom_thankyou_page]', 'options' => $pages_array, 'class' => 'wcfm-select wcfm_ele', 'label_class' => 'wcfm_title', 'value' => $wcfm_custom_thankyou_page, 'desc_class' => 'wcfm_page_options_desc', 'desc' => __( 'You have created your own thank you page then set that here.', 'wc-multivendor-membership') ),
					  ...
					  <div class="wcfm_clearfix"></div>
						<?php
							$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'membership_setting_thankyou_fields', array(  
																																				...
																																				'free_thankyou_content' => array( 'label' => __( 'Free Membership Thank You page content', 'wc-multivendor-membership' ), 'type' => 'wpeditor', 'class' => 'wcfm-text wcfm_ele wcfm_wpeditor', 'label_class' => 'wcfm_title wcfm_full_ele_title', 'value' => $free_thankyou_content, 'hints' => __( 'This content will be visible when user subscribe to FREE plan.', 'wc-multivendor-membership' ), 'desc' => __( 'Please don\'t include Dashboard URL, it will be automatically append with the content.', 'wc-multivendor-membership' ) ),
																																				) ) );
						?>
					  ...
					  <div class="wcfm_clearfix"></div>
						<?php
							$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'membership_setting_thankyou_approval_fields', array(  
																																				'subscription_thankyou_content' => array( 'label' => __( 'Subscription membership Thank You page content', 'wc-multivendor-membership' ), 'type' => 'wpeditor', 'class' => 'wcfm-text wcfm_ele wcfm_wpeditor', 'label_class' => 'wcfm_title wcfm_full_ele_title', 'value' => $subscription_thankyou_content, 'hints' => __( 'This content will be visible when user pay via PayPal.', 'wc-multivendor-membership' ) )
																																				) ) );
						?>
						<div class="wcfm_clearfix"></div>
					</div>
