        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "requiredInFunction": { 
                    ...
                    "alertText": "* Pole musi być równe testowi"
                },
                "minSize": {
                    "regex": "none",
				...
				{
                     "regex": /^[a-zA-Z\ \_\,\`\.\'\^\-]+$/,
                    "alertText": "* Tylko litery i ' _,`.'^-' Dozwolone znaki"
                },
				...
				{
                    "regex": /^[0-9a-zA-Z\ \_\,\`\.\'\^]+$/,
                    "alertText": "* Tylko litery, cyfry i ' _,`.'^' Dozwolone znaki"
                },
				...
				{
                    "regex": /^[0-9\ \-\+]+$/,
                    "alertText": "* Tylko liczby i ' -+' Dozwolone znaki"
                }, 
                ...
                "ajaxUserCall": {
                    ...
                    "extraData": "name=eric",
                    "alertText": "* Ta nazwa użytkownika jest już zarejestrowana",
