(function($){
    ...
    $.validationEngineLanguage = {
		...
		"groupRequired": {
				...
				{
                     "regex": /^[a-zA-Z\u0400-\u04FF\ \_\,\`\.\'\^\-]+$/,
                    "alertText": "* Только буквы и ' _,`.'^-' Разрешенные символы"
                },
				...
				{
                    "regex": /^[0-9a-zA-Z\u0400-\u04FF\ \_\,\`\.\'\^]+$/,
                    "alertText": "* Только буквы, цифры и ' _,`.'^' Разрешенные символы"
                },
				...
				{
                    "regex": /^[0-9\ \-\+]+$/,
                    "alertText": "* Только цифры и ' -+' Разрешенные символы"
                }, 
                ...
                "ajaxUserCall": {
                    ...
                    "extraData": "name=eric",
                    "alertText": "* Этот пользователь - имя пользователя уже зарегистрирован",
