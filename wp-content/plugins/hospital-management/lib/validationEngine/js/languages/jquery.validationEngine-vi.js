    ...
    $.validationEngineLanguage = {
        newLang: function(){
            $.validationEngineLanguage.allRules = {
				...
				{
                     "regex": /^[a-zA-Z\ \_\,\`\.\'\^\-]+$/,
                    "alertText": "* Chỉ có chữ cái và ' _,`.'^-' Cho phép nhân vật"
                },
				...
				{
                    "regex": /^[0-9a-zA-Z\ \_\,\`\.\'\^]+$/,
                    "alertText": "* Chỉ có chữ cái, số và ' _,`.'^' Cho phép nhân vật"
                },
				...
				{
                    "regex": /^[0-9\ \-\+]+$/,
                    "alertText": "* Chỉ số và ' -+' Cho phép nhân vật"
                }, 
                ...
                "ajaxUserCall": {
                    ...
                    "extraData": "name=eric",
                    "alertText": "* Tên người dùng này đã được đăng ký",
