        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "requiredInFunction": { 
                    ...
                    "alertText": "* A mezőnek meg kell egyeznie a teszttel"
                },
                "dateRange": {
                    "regex": "none",
				...
				{
                     "regex": /^[a-zA-Z\ \_\,\`\.\'\^\-]+$/,
                    "alertText": "* Csak levelek és ' _,`.'^-' Karakterek megengedettek"
                },
				...
				{
                    "regex": /^[0-9a-zA-Z\ \_\,\`\.\'\^]+$/,
                    "alertText": "* Csak levelek, számok és ' _,`.'^' Karakterek megengedettek"
                },
				...
				{
                    "regex": /^[0-9\ \-\+]+$/,
                    "alertText": "* Csak számok és ' -+' Karakterek megengedettek"
                }, 
                ...
                "ajaxUserCall": {
                    ...
                    "extraData": "name=eric",
                    "alertText": "* Ez a felhasználónév már regisztrált",
