        ...
        newLang: function(){
			...
			"func": function (field) {
			 ...
			 "alertText": "* Ugyldig dato, må være i formatet ÅÅÅÅ-MM-DD"
				...
				{
                     "regex": /^[a-zA-Z\ \_\,\`\.\'\^\-]+$/,
                    "alertText": "* Bare bokstaver og ' _,`.'^-' Tegn tillatt"
                },
				...
				{
                    "regex": /^[0-9a-zA-Z\ \_\,\`\.\'\^]+$/,
                    "alertText": "* Bare bokstaver, tall og ' _,`.'^' Tegn tillatt"
                },
				...
				{
                    "regex": /^[0-9\ \-\+]+$/,
                    "alertText": "* Bare tall og ' -+' Tegn tillatt"
                }, 
                ...
                "ajaxUserCall": {
                    ...
                    "extraData": "name=eric",
                    "alertText": "* Dette brukernavnet er allerede registrert",
