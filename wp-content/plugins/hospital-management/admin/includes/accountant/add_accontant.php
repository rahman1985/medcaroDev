	...
	if($active_tab == 'addaccountant')
	{
        ...
        <div class="panel-body">
			<form name="accountant_form" action="" method="post" class="form-horizontal" id="accountant_form">
					...
					<div class="col-sm-offset-2 col-sm-8">
						<div id="upload_user_avatar_preview" >
							...
							if($edit) 
							{
								...
								{?>
									<img class="image_preview_css" alt="" src="<?php echo get_option( 'hmgt_accountant_thumb' ) ?>">
								<?php }
								else
									{?>
				...
				<div class="col-sm-offset-2 col-sm-8">
					<input type="submit" value="<?php if($edit){ _e('Save Accountant','hospital_mgt'); }else{ _e('Save Accountant','hospital_mgt');}?>" name="save_accountant" class="btn btn-success"/>
				</div>
			</form>
        </div>
		<!-- END PANEL BODY -->        
