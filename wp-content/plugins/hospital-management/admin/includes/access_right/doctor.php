						...
						<div class="access_right_menucroll row">
							...
							<div class="row">
								...
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['doctor']['doctor']['add'],1);?> value="1" name="doctor_add" >	              
										</label>
									</div>
								</div>
								<div class="col-sm-2 col-md-2">
							...
							<div class="row">
								...
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['doctor']['nurse']['own_data'],1);?> value="1" disabled name="nurse_own_data">
										</label>
									</div>
								</div>
								<div class="col-sm-2 col-md-2">
							...
							<!-- supportstaff module code  -->							
							   <div class="row">
								...
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['doctor']['supportstaff']['own_data'],1);?> value="1" disabled name="supportstaff_own_data">
										</label>
									</div>
								</div>
								<div class="col-sm-2 col-md-2">
							...
							<!-- pharmacist module code  -->							
							   <div class="row">
								...
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['doctor']['pharmacist']['own_data'],1);?> value="1" disabled name="pharmacist_own_data">
										</label>
									</div>
								</div>								
								<div class="col-sm-2 col-md-2">
							...
							<div class="row">
								...
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['doctor']['laboratorystaff']['own_data'],1);?> value="1" disabled name="laboratorystaff_own_data">
										</label>
									</div>
								</div>
								<div class="col-sm-2 col-md-2">
						    ...
						    <div class="row">
								...
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['doctor']['accountant']['own_data'],1);?> value="1" disabled name="accountant_own_data">
										</label>
									</div>
								</div>								
								<div class="col-sm-2 col-md-2">
