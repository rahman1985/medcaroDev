	...
	<div id="main-wrapper"><!--- MAIN WRAPPER DIV START -->
	    <div class="panel panel-white"><!--- PANEL WHITE DIV START -->
			<div class="panel-body"><!--- PANEL BODY DIV START -->
				<h2>
					<?php echo esc_html( __('Patient Access Right', 'hospital_mgt')); ?>
				</h2>
				<div class="panel-body"><!--- PANEL BODY DIV START -->
					<form name="student_form" action="" method="post" class="form-horizontal" id="access_right_form">
						...
						<div class="access_right_menucroll row">
							...
							<div class="row">
								...
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['doctor']['add'],1);?> value="1" name="doctor_add" >	              
										</label>
									</div>
								</div>
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['doctor']['edit'],1);?> value="1" name="doctor_edit" >	              
										</label>
									</div>
								</div>
								...
								<div class="col-sm-2 col-md-1">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['doctor']['delete'],1);?> value="1" name="doctor_delete" >	              
										</label>
									</div>
								</div>
							...
							<!-- outpatient module code  -->
							   ...
							   <div class="row">
								...
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['outpatient']['add'],1);?> value="1" name="outpatient_add" >	              
										</label>
									</div>
								</div>
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['outpatient']['edit'],1);?> value="1" name="outpatient_edit" >	              
										</label>
									</div>
								</div>
								...
								<div class="col-sm-2 col-md-1">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['outpatient']['delete'],1);?> value="1" name="outpatient_delete" >	              
										</label>
									</div>
								</div>
							...
							<!-- patient module code  -->
							   ...
							   <div class="row">
								...
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['patient']['add'],1);?> value="1" name="patient_add" >	              
										</label>
									</div>
								</div>
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['patient']['edit'],1);?> value="1" name="patient_edit" >	              
										</label>
									</div>
								</div>
								...
								<div class="col-sm-2 col-md-1">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['patient']['delete'],1);?> value="1" name="patient_delete" >	              
										</label>
									</div>
								</div>
							...
							<!-- nurse module code  -->
							   ...
							   <div class="row">
								...
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['nurse']['add'],1);?> value="1" name="nurse_add" >	              
										</label>
									</div>
								</div>
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['nurse']['edit'],1);?> value="1" name="nurse_edit" >	              
										</label>
									</div>
								</div>
								...
								<div class="col-sm-2 col-md-1">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['nurse']['delete'],1);?> value="1" name="nurse_delete" >	              
										</label>
									</div>
								</div>
							...
							<!-- supportstaff module code  -->
							   ...
							   <div class="row">
								...
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['supportstaff']['add'],1);?> value="1" name="supportstaff_add" >	              
										</label>
									</div>
								</div>
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['supportstaff']['edit'],1);?> value="1" name="supportstaff_edit" >	              
										</label>
									</div>
								</div>
								...
								<div class="col-sm-2 col-md-1">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['supportstaff']['delete'],1);?> value="1" name="supportstaff_delete" >	              
										</label>
									</div>
								</div>								
							</div>						
							...
							<!-- pharmacist module code  -->
							   ...
							   <div class="row">
								...
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['pharmacist']['add'],1);?> value="1" name="pharmacist_add" >	              
										</label>
									</div>
								</div>
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['pharmacist']['edit'],1);?> value="1" name="pharmacist_edit" >	              
										</label>
									</div>
								</div>
								...
								<div class="col-sm-2 col-md-1">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['pharmacist']['delete'],1);?> value="1" name="pharmacist_delete" >	              
										</label>
									</div>
								</div>
							...
							<!-- laboratorystaff module code  -->
							   ...
							   <div class="row">
								...
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['laboratorystaff']['add'],1);?> value="1" name="laboratorystaff_add" >	              
										</label>
									</div>
								</div>
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['laboratorystaff']['edit'],1);?> value="1" name="laboratorystaff_edit" >	              
										</label>
									</div>
								</div>
								...
								<div class="col-sm-2 col-md-1">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['laboratorystaff']['delete'],1);?> value="1" name="laboratorystaff_delete" >	              
										</label>
									</div>
								</div>
							...
							<!-- accountant module code  -->
							   ...
							   <div class="row">		  
								...
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['accountant']['add'],1);?> value="1" name="accountant_add" >	              
										</label>
									</div>
								</div>
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['accountant']['edit'],1);?> value="1" name="accountant_edit" >	              
										</label>
									</div>
								</div>
								...
								<div class="col-sm-2 col-md-1">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['accountant']['delete'],1);?> value="1" name="accountant_delete" >	              
										</label>
									</div>
								</div>
							...
							<!-- medicine module code  -->
							   ...
							   <div class="row">
								...
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['medicine']['add'],1);?> value="1" name="medicine_add" >	              
										</label>
									</div>
								</div>
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['medicine']['edit'],1);?> value="1" name="medicine_edit" >	              
										</label>
									</div>
								</div>
								...
								<div class="col-sm-2 col-md-1">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['medicine']['delete'],1);?> value="1" name="medicine_delete" >	              
										</label>
									</div>
								</div>
							...
							<!-- treatment module code  -->
							   ...
							   <div class="row">		  
								...
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['treatment']['add'],1);?> value="1" name="treatment_add" >	              
										</label>
									</div>
								</div>
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['treatment']['edit'],1);?> value="1" name="treatment_edit" >	              
										</label>
									</div>
								</div>
								...
								<div class="col-sm-2 col-md-1">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['treatment']['delete'],1);?> value="1" name="treatment_delete" >	              
										</label>
									</div>
								</div>
							...
							<!-- prescription module code  -->
							   ...
							   <div class="row">		  
								...
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['prescription']['add'],1);?> value="1" name="prescription_add" >	              
										</label>
									</div>
								</div>
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['prescription']['edit'],1);?> value="1" name="prescription_edit" >	              
										</label>
									</div>
								</div>
								...
								<div class="col-sm-2 col-md-1">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['prescription']['delete'],1);?> value="1" name="prescription_delete" >	              
										</label>
									</div>
								</div>
							...
							<!-- bedallotment module code  -->
							   ...
							   <div class="row">
								...
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['bedallotment']['add'],1);?> value="1" name="bedallotment_add" >	              
										</label>
									</div>
								</div>
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['bedallotment']['edit'],1);?> value="1" name="bedallotment_edit" >	              
										</label>
									</div>
								</div>
								...
								<div class="col-sm-2 col-md-1">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['bedallotment']['delete'],1);?> value="1" name="bedallotment_delete" >	              
										</label>
									</div>
								</div>
							...
							<!-- operation module code  -->
							   ...
							   <div class="row">
								...
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['operation']['add'],1);?> value="1" name="operation_add" >	              
										</label>
									</div>
								</div>
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['operation']['edit'],1);?> value="1" name="operation_edit" >	              
										</label>
									</div>
								</div>
								...
								<div class="col-sm-2 col-md-1">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['operation']['delete'],1);?> value="1" name="operation_delete" >	              
										</label>
									</div>
								</div>
							...
							<!-- diagnosis module code  -->
							   ...
							   <div class="row">		   
								...
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['diagnosis']['add'],1);?> value="1" name="diagnosis_add" >	              
										</label>
									</div>
								</div>
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['diagnosis']['edit'],1);?> value="1" name="diagnosis_edit" >	              
										</label>
									</div>
								</div>
								...
								<div class="col-sm-2 col-md-1">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['diagnosis']['delete'],1);?> value="1" name="diagnosis_delete" >	              
										</label>
									</div>
								</div>
							...
							<!-- bloodbank module code  -->
							   ...
							   <div class="row">		 
								...
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['bloodbank']['add'],1);?> value="1" name="bloodbank_add" >	              
										</label>
									</div>
								</div>
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['bloodbank']['edit'],1);?> value="1" name="bloodbank_edit" >	              
										</label>
									</div>
								</div>
								...
								<div class="col-sm-2 col-md-1">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['bloodbank']['delete'],1);?> value="1" name="bloodbank_delete" >	              
										</label>
									</div>
								</div>
							...
							<!-- invoice module code  -->
							   ...
							   <div class="row">		  
								...
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['invoice']['add'],1);?> value="1" name="invoice_add" >	              
										</label>
									</div>
								</div>
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['invoice']['edit'],1);?> value="1" name="invoice_edit" >	              
										</label>
									</div>
								</div>
								...
								<div class="col-sm-2 col-md-1">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['invoice']['delete'],1);?> value="1" name="invoice_delete" >	              
										</label>
									</div>
								</div>
							...
							<!-- instrument module code  -->
							   ...
							   <div class="row">		  
								...
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['instrument']['add'],1);?> value="1" name="instrument_add" >	              
										</label>
									</div>
								</div>
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['instrument']['edit'],1);?> value="1" name="instrument_edit" >	              
										</label>
									</div>
								</div>
								...
								<div class="col-sm-2 col-md-1">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['patient']['instrument']['delete'],1);?> value="1" name="instrument_delete" >	              
										</label>
									</div>
								</div>
						...
						<div class="col-sm-offset-2 col-sm-8 row_bottom">							
							<input type="submit" value="<?php _e('Save', 'hospital_mgt' ); ?>" name="save_access_right_patient" class="btn btn-success"/>
						</div>
					</form>
		        </div><!---END PANEL BODY DIV -->
            </div><!--- END PANEL BODY DIV-->
