...
if($active_tab == 'addpharmacist')
{
	...
	if(isset($_REQUEST['pharmacist_id']))
		$pharmacist_id=$_REQUEST['pharmacist_id'];
		$edit=0;
		...
		<div class="panel-body"><!--panel BODY DIV START-->	      
			<form name="pharmacist_form" action="" method="post" class="form-horizontal" id="pharmacist_form">
					...
					<div class="col-sm-offset-2 col-sm-8">
						 <div id="upload_user_avatar_preview" >
							 <?php if($edit) 
								...
								{?>
								<img class="image_preview_css" alt="" src="<?php echo get_option( 'hmgt_pharmacist_thumb' ) ?>">
								<?php }
								else {?>
				...
				<div class="col-sm-offset-2 col-sm-8">
					<input type="submit" value="<?php if($edit){ _e('Save Pharmacist','hospital_mgt'); }else{ _e('Save Pharmacist','hospital_mgt');}?>" name="save_pharmacist" class="btn btn-success"/>
				</div>
			</form>
