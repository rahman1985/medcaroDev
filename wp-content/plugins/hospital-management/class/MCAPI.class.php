...
class MJ_GYM_MCAPI {
    ...
    /**
     * shedule a campaign to be sent in the future
     *
     * @section Campaign  Related
     * @example mcapi_campaignSchedule.php
     * @example xml-rpc_campaignSchedule.php
     *
     * @param string $cid the id of the campaign to shedule
     * @param string $schedule_time the time to shedule the campaign. For A/B Split "shedule" campaigns, the time for Group A - in YYYY-MM-DD HH:II:SS format in <strong>GMT</strong>
     * @param string $schedule_time_b optional -the time to shedule Group B of an A/B Split "shedule" campaign - in YYYY-MM-DD HH:II:SS format in <strong>GMT</strong>
     * @return boolean true on success
     */
    ...
    * @param array $type_opts optional - 
            For RSS Campaigns this, array should contain:
                ...
                string shedule optional one of "daily", "weekly", "monthly" - defaults to "daily"
                string schedule_hour optional an hour between 0 and 24 - default to 4 (4am <em>local time</em>) - applies to all shedule types
            ...
            For A/B Split campaigns, this array should contain:
                string split_test The values to segment based on. Currently, one of: "subject", "from_name", "shedule". NOTE, for "shedule", you will need to call campaignSchedule() separately!
                ...
                int split_size optional this is a percentage of what size the Campaign's List plus any segmentation options results in. "shedule" type forces 50%, all others default to 10%
    ...
    */
     ...
     * @param array $filters a hash of filters to apply to this query - all are optional:
            ...
            string  status optional - return campaigns of a specific status - one of "sent", "save", "paused", "shedule", "sending". Accepts multiples separated by commas when not using exact matching.
     ...
     * @returnf array data the data for each campaign being returned
            ...
            string status Status of the given campaign (save,paused,shedule,sending,sent)
