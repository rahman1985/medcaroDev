...
class Hospital_Management
{
	...
	function __construct($user_id = NULL)
	{
		if($user_id)
		{
			...
			if($this->role == 'doctor')
			{
				...
				$this->appointment = $this->get_appointment_list($user_id);	
				...
				$this->all_own_events_notice = $this->get_all_own_event_notice_list($user_id,'doctor');
			}
			if($this->role == 'patient')
			{
				...
				$this->all_own_events_notice = $this->get_all_own_event_notice_list($user_id,'patient');
			...
			if($this->role == 'nurse')
			{
				...
				$this->all_own_events_notice = $this->get_all_own_event_notice_list($user_id,'nurse');
				$this->prescription = $this->get_pharmacist_prescription();
			}
			if($this->role == 'receptionist')
			{
				...
				$this->all_own_events_notice = $this->get_all_own_event_notice_list($user_id,'receptionist');
			}
			if($this->role == 'accountant')
			{
				...
				$this->all_own_events_notice = $this->get_all_own_event_notice_list($user_id,'accountant');
			}
			if($this->role == 'pharmacist')
			{
				...
				$this->all_own_events_notice = $this->get_all_own_event_notice_list($user_id,'pharmacist');
				$this->prescription = $this->get_pharmacist_prescription();
			}
			if($this->role == 'laboratorist')
			{
				...
				$this->all_own_events_notice = $this->get_all_own_event_notice_list($user_id,'laboratorist');
			}
	...
	//Doctore appointment
	public function get_appointment_list($user_id)
	{
		global $wpdb;
		$table_appointment = $wpdb->prefix. 'hmgt_appointment';
		$table_users = $wpdb->prefix."users";
	...
	public function get_all_own_event_notice_list($user_id,$role)
	{
		global $wpdb;
		$table_posts = $wpdb->prefix. 'posts';
		$table_postmeta = $wpdb->prefix."postmeta";
