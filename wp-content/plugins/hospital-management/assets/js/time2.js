...
(function ( $ ) {
    ...
    $.fn.timepicki = function(options) {
        ...
        return this.each( function() {
            ...
            //ele_par.append("<div class='timepicker_wrap'><div class='arrow_top'></div><div class='time'><div class='prev timepicker_prev'></div><div class='ti_tx'></div><div class='next timepicker_next'></div></div><div class='mins'><div class='prev timepicker_prev'></div><div class='mi_tx'></div><div class='next timepicker_next'></div></div><div class='meridian'><div class='prev timepicker_prev'></div><div class='mer_tx'></div><div class='next timepicker_next'></div></div></div>");
			 ele_par.append("<div class='timepicker_wrap'><div class='arrow_top'></div><div class='time'><div class='timepicker_prev'></div><div class='ti_tx'></div><div class='timepicker_next'></div></div><div class='mins'><div class='timepicker_prev'></div><div class='mi_tx'></div><div class='timepicker_next'></div></div><div class='meridian'><div class='timepicker_prev'></div><div class='mer_tx'></div><div class='timepicker_next'></div></div></div>");
            ...
            function set_date()
            {
                ...
                var cur_next = ele_next.find(".timepicker_next");
                var cur_prev = ele_next.find(".timepicker_prev");
            ...
            $(cur_prev).add(cur_next).on("click", function () {
                ...
                if (cur_ele.parent().attr("class") == "time") {
                    ...
                    if (cur_ele.attr("class") == "timepicker_next") {
                        //alert("nex");
                        if (cur_time == 12) {
